// This Component shoes the humidity and Wind level etc in frontend. as you can see the 4 boxes on right side.
...
function Highlights({stats}) {
  return (
    ...
    <div className='bg-slate-600 p-2 text-slate-200 justify-start flex flex-col items-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer'>
